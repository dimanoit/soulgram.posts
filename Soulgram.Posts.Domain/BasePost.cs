...
public record BasePost
{
    ...
    [Nested] public IEnumerable<UserInteraction> Likes { get; init; } = Enumerable.Empty<UserInteraction>();

    [Nested] public IEnumerable<UserInteraction> Views { get; init; } = Enumerable.Empty<UserInteraction>();
